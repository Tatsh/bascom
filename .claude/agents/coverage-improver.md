...
1. Run `uv run pytest --cov bascom --cov-branch --cov-report term-missing:skip-covered`
...
4. Run `uv run pytest --cov bascom --cov-branch --cov-report term-missing:skip-covered`
